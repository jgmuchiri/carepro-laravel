                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('address_line_1') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="address_line_1" type="text" class="form-control" name="address_line_1" required placeholder="Street and number, P.O. box, c/o.">
                        ...
                        <div class="form-group{{ $errors->has('address_line_2') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="address_line_2" type="text" class="form-control" name="address_line_2" placeholder="Apartment, suite, unit, building, floor, etc.">
