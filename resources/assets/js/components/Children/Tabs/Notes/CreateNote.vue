                ...
                <form v-on:submit.prevent="storeNote">
                    <div class="row">
                        <div class="form-group col-md-6">
                            <input id="title" class="form-control input-lg" :placeholder="$t('Title')" v-model="note.title" type="text" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <button class="btn btn-danger waves-effect m-b-5" v-on:click.prevent="switchView('NoteIndex')" v-bind:class="{ disabled: loading }">
                                <span>{{ $t('Cancel') }}</span>
                            </button>
                        </div>
                        <div class="col-md-6">
                            <button class="btn btn-success waves-effect m-b-5 pull-right" v-bind:class="{ disabled: loading }"><span>{{ $t('Save') }}</span></button>
                        </div>
                    </div>
                </form>
            </div>
